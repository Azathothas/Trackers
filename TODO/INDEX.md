...
| [T-012](claims.md) | P0 | claims | **done** | Nobody has measured whether our User-Agent gets us blocked |
| [T-087](operations.md) | P0 | operations | **done** | The rotation is a wall-clock bucket, so two runs took one slice |
...
| [T-004](claims.md) | P1 | claims | **done** | Vantage bias is unresolved and the dataset cannot distinguish dead from dead-from-AS8075 |
